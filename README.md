...
```javascript
import normalize from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-float64-base-normalize@v0.2.1-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/number-float64-base-normalize/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/number-float64-base-normalize/actions/workflows/test.yml?query=branch:v0.2.1
