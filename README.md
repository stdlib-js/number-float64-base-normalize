...
```javascript
import normalize from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-float64-base-normalize@v0.2.2-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { assign } from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-float64-base-normalize@v0.2.2-esm/index.mjs';
```
